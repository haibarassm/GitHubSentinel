...
from arxiv_client import ArxivClient  # 从arxiv_client模块导入ArxivClient类，用于arXiv API操作
...
def main():
    ...
    command_handler = CommandHandler(github_client, subscription_manager, report_generator, arxiv_client)  # 创建命令处理器实例，传入arXiv客户端
